...
mixin _$Rider {
 ...
 int get id;@JsonKey(name: 'firebase_uid') String get firebaseUid;@JsonKey(name: 'role_id') int get roleId; String get email; String get name;@JsonKey(name: 'last_name') String get lastName; String get nickname;@JsonKey(name: 'icon_image') String? get iconImage; String? get bio;@JsonKey(name: 'city_id') int? get cityId;@JsonKey(name: 'city_text') String? get cityText;@JsonKey(name: 'city_name') String? get cityName;@JsonKey(name: 'country_id') int? get countryId; String? get gender;@JsonKey(name: 'social_links') Map<String, dynamic>? get socialLinks;@JsonKey(name: 'reputation_pts') int get reputationPts;@JsonKey(name: 'active_sport_id') int? get activeSportId;@JsonKey(name: 'map_sport_filter') List<int>? get mapSportFilter;@JsonKey(name: 'created_date') DateTime get createdDate;@JsonKey(name: 'updated_date') DateTime? get updatedDate;
...
@useResult
$Res call({
 int id,@JsonKey(name: 'firebase_uid') String firebaseUid,@JsonKey(name: 'role_id') int roleId, String email, String name,@JsonKey(name: 'last_name') String lastName, String nickname,@JsonKey(name: 'icon_image') String? iconImage, String? bio,@JsonKey(name: 'city_id') int? cityId,@JsonKey(name: 'city_text') String? cityText,@JsonKey(name: 'city_name') String? cityName,@JsonKey(name: 'country_id') int? countryId, String? gender,@JsonKey(name: 'social_links') Map<String, dynamic>? socialLinks,@JsonKey(name: 'reputation_pts') int reputationPts,@JsonKey(name: 'active_sport_id') int? activeSportId,@JsonKey(name: 'map_sport_filter') List<int>? mapSportFilter,@JsonKey(name: 'created_date') DateTime createdDate,@JsonKey(name: 'updated_date') DateTime? updatedDate
});
...
/// Create a copy of Rider
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? firebaseUid = null,Object? roleId = null,Object? email = null,Object? name = null,Object? lastName = null,Object? nickname = null,Object? iconImage = freezed,Object? bio = freezed,Object? cityId = freezed,Object? cityText = freezed,Object? cityName = freezed,Object? countryId = freezed,Object? gender = freezed,Object? socialLinks = freezed,Object? reputationPts = null,Object? activeSportId = freezed,Object? mapSportFilter = freezed,Object? createdDate = null,Object? updatedDate = freezed,}) {
...
as int?,cityText: freezed == cityText ? _self.cityText : cityText // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'firebase_uid')  String firebaseUid, @JsonKey(name: 'role_id')  int roleId,  String email,  String name, @JsonKey(name: 'last_name')  String lastName,  String nickname, @JsonKey(name: 'icon_image')  String? iconImage,  String? bio, @JsonKey(name: 'city_id')  int? cityId, @JsonKey(name: 'city_text')  String? cityText, @JsonKey(name: 'city_name')  String? cityName, @JsonKey(name: 'country_id')  int? countryId,  String? gender, @JsonKey(name: 'social_links')  Map<String, dynamic>? socialLinks, @JsonKey(name: 'reputation_pts')  int reputationPts, @JsonKey(name: 'active_sport_id')  int? activeSportId, @JsonKey(name: 'map_sport_filter')  List<int>? mapSportFilter, @JsonKey(name: 'created_date')  DateTime createdDate, @JsonKey(name: 'updated_date')  DateTime? updatedDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Rider() when $default != null:
return $default(_that.id,_that.firebaseUid,_that.roleId,_that.email,_that.name,_that.lastName,_that.nickname,_that.iconImage,_that.bio,_that.cityId,_that.cityText,_that.cityName,_that.countryId,_that.gender,_that.socialLinks,_that.reputationPts,_that.activeSportId,_that.mapSportFilter,_that.createdDate,_that.updatedDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'firebase_uid')  String firebaseUid, @JsonKey(name: 'role_id')  int roleId,  String email,  String name, @JsonKey(name: 'last_name')  String lastName,  String nickname, @JsonKey(name: 'icon_image')  String? iconImage,  String? bio, @JsonKey(name: 'city_id')  int? cityId, @JsonKey(name: 'city_text')  String? cityText, @JsonKey(name: 'city_name')  String? cityName, @JsonKey(name: 'country_id')  int? countryId,  String? gender, @JsonKey(name: 'social_links')  Map<String, dynamic>? socialLinks, @JsonKey(name: 'reputation_pts')  int reputationPts, @JsonKey(name: 'active_sport_id')  int? activeSportId, @JsonKey(name: 'map_sport_filter')  List<int>? mapSportFilter, @JsonKey(name: 'created_date')  DateTime createdDate, @JsonKey(name: 'updated_date')  DateTime? updatedDate)  $default,) {final _that = this;
switch (_that) {
case _Rider():
return $default(_that.id,_that.firebaseUid,_that.roleId,_that.email,_that.name,_that.lastName,_that.nickname,_that.iconImage,_that.bio,_that.cityId,_that.cityText,_that.cityName,_that.countryId,_that.gender,_that.socialLinks,_that.reputationPts,_that.activeSportId,_that.mapSportFilter,_that.createdDate,_that.updatedDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'firebase_uid')  String firebaseUid, @JsonKey(name: 'role_id')  int roleId,  String email,  String name, @JsonKey(name: 'last_name')  String lastName,  String nickname, @JsonKey(name: 'icon_image')  String? iconImage,  String? bio, @JsonKey(name: 'city_id')  int? cityId, @JsonKey(name: 'city_text')  String? cityText, @JsonKey(name: 'city_name')  String? cityName, @JsonKey(name: 'country_id')  int? countryId,  String? gender, @JsonKey(name: 'social_links')  Map<String, dynamic>? socialLinks, @JsonKey(name: 'reputation_pts')  int reputationPts, @JsonKey(name: 'active_sport_id')  int? activeSportId, @JsonKey(name: 'map_sport_filter')  List<int>? mapSportFilter, @JsonKey(name: 'created_date')  DateTime createdDate, @JsonKey(name: 'updated_date')  DateTime? updatedDate)?  $default,) {final _that = this;
switch (_that) {
case _Rider() when $default != null:
return $default(_that.id,_that.firebaseUid,_that.roleId,_that.email,_that.name,_that.lastName,_that.nickname,_that.iconImage,_that.bio,_that.cityId,_that.cityText,_that.cityName,_that.countryId,_that.gender,_that.socialLinks,_that.reputationPts,_that.activeSportId,_that.mapSportFilter,_that.createdDate,_that.updatedDate);case _:
  return null;
...
@override@JsonKey(name: 'city_text') final  String? cityText;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Rider&&(identical(other.id, id) || other.id == id)&&(identical(other.firebaseUid, firebaseUid) || other.firebaseUid == firebaseUid)&&(identical(other.roleId, roleId) || other.roleId == roleId)&&(identical(other.email, email) || other.email == email)&&(identical(other.name, name) || other.name == name)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.nickname, nickname) || other.nickname == nickname)&&(identical(other.iconImage, iconImage) || other.iconImage == iconImage)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.cityId, cityId) || other.cityId == cityId)&&(identical(other.cityText, cityText) || other.cityText == cityText)&&(identical(other.cityName, cityName) || other.cityName == cityName)&&(identical(other.countryId, countryId) || other.countryId == countryId)&&(identical(other.gender, gender) || other.gender == gender)&&const DeepCollectionEquality().equals(other._socialLinks, _socialLinks)&&(identical(other.reputationPts, reputationPts) || other.reputationPts == reputationPts)&&(identical(other.activeSportId, activeSportId) || other.activeSportId == activeSportId)&&const DeepCollectionEquality().equals(other._mapSportFilter, _mapSportFilter)&&(identical(other.createdDate, createdDate) || other.createdDate == createdDate)&&(identical(other.updatedDate, updatedDate) || other.updatedDate == updatedDate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,firebaseUid,roleId,email,name,lastName,nickname,iconImage,bio,cityId,cityText,cityName,countryId,gender,const DeepCollectionEquality().hash(_socialLinks),reputationPts,activeSportId,const DeepCollectionEquality().hash(_mapSportFilter),createdDate,updatedDate]);
...
/// Create a copy of Rider
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? firebaseUid = null,Object? roleId = null,Object? email = null,Object? name = null,Object? lastName = null,Object? nickname = null,Object? iconImage = freezed,Object? bio = freezed,Object? cityId = freezed,Object? cityText = freezed,Object? cityName = freezed,Object? countryId = freezed,Object? gender = freezed,Object? socialLinks = freezed,Object? reputationPts = null,Object? activeSportId = freezed,Object? mapSportFilter = freezed,Object? createdDate = null,Object? updatedDate = freezed,}) {
  return _then(_Rider(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,firebaseUid: null == firebaseUid ? _self.firebaseUid : firebaseUid // ignore: cast_nullable_to_non_nullable
as String,roleId: null == roleId ? _self.roleId : roleId // ignore: cast_nullable_to_non_nullable
