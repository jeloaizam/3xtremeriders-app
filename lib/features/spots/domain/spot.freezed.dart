...
mixin _$Spot {
 ...
 int get id; String get name; String get description; double get latitude; double get longitude; int? get difficulty;@JsonKey(name: 'best_season') String? get bestSeason; String? get neighborhood;@JsonKey(name: 'open_hour') String? get openHour;@JsonKey(name: 'close_hour') String? get closeHour;@JsonKey(name: 'created_by') int get createdBy;@JsonKey(name: 'state_id') int? get stateId;@JsonKey(name: 'city_id') int? get cityId;@JsonKey(name: 'country_id') int? get countryId;@JsonKey(name: 'city_name') String? get cityName;@JsonKey(name: 'country_name') String? get countryName;@JsonKey(name: 'category_id') int get categoryId;@JsonKey(name: 'category_name') String get categoryName;@JsonKey(name: 'rating_avg') double? get ratingAvg;@JsonKey(name: 'rating_count') int get ratingCount;@JsonKey(name: 'hazard_avg') double? get hazardAvg;@JsonKey(name: 'hazard_count') int get hazardCount;@JsonKey(name: 'vote_count') int get voteCount;@JsonKey(name: 'cover_photo_url') String? get coverPhotoUrl;@JsonKey(name: 'cover_video_url') String? get coverVideoUrl;@JsonKey(name: 'cover_video_thumbnail_url') String? get coverVideoThumbnailUrl;@JsonKey(name: 'top_media_type') String? get topMediaType;@JsonKey(name: 'created_date') DateTime get createdDate;@JsonKey(name: 'updated_date') DateTime? get updatedDate;@JsonKey(name: 'sport_ids') List<int> get sportIds;
...
@useResult
$Res call({
 int id, String name, String description, double latitude, double longitude, int? difficulty,@JsonKey(name: 'best_season') String? bestSeason, String? neighborhood,@JsonKey(name: 'open_hour') String? openHour,@JsonKey(name: 'close_hour') String? closeHour,@JsonKey(name: 'created_by') int createdBy,@JsonKey(name: 'state_id') int? stateId,@JsonKey(name: 'city_id') int? cityId,@JsonKey(name: 'country_id') int? countryId,@JsonKey(name: 'city_name') String? cityName,@JsonKey(name: 'country_name') String? countryName,@JsonKey(name: 'category_id') int categoryId,@JsonKey(name: 'category_name') String categoryName,@JsonKey(name: 'rating_avg') double? ratingAvg,@JsonKey(name: 'rating_count') int ratingCount,@JsonKey(name: 'hazard_avg') double? hazardAvg,@JsonKey(name: 'hazard_count') int hazardCount,@JsonKey(name: 'vote_count') int voteCount,@JsonKey(name: 'cover_photo_url') String? coverPhotoUrl,@JsonKey(name: 'cover_video_url') String? coverVideoUrl,@JsonKey(name: 'cover_video_thumbnail_url') String? coverVideoThumbnailUrl,@JsonKey(name: 'top_media_type') String? topMediaType,@JsonKey(name: 'created_date') DateTime createdDate,@JsonKey(name: 'updated_date') DateTime? updatedDate,@JsonKey(name: 'sport_ids') List<int> sportIds
});
...
/// Create a copy of Spot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? latitude = null,Object? longitude = null,Object? difficulty = freezed,Object? bestSeason = freezed,Object? neighborhood = freezed,Object? openHour = freezed,Object? closeHour = freezed,Object? createdBy = null,Object? stateId = freezed,Object? cityId = freezed,Object? countryId = freezed,Object? cityName = freezed,Object? countryName = freezed,Object? categoryId = null,Object? categoryName = null,Object? ratingAvg = freezed,Object? ratingCount = null,Object? hazardAvg = freezed,Object? hazardCount = null,Object? voteCount = null,Object? coverPhotoUrl = freezed,Object? coverVideoUrl = freezed,Object? coverVideoThumbnailUrl = freezed,Object? topMediaType = freezed,Object? createdDate = null,Object? updatedDate = freezed,Object? sportIds = null,}) {
...
as String?,coverVideoThumbnailUrl: freezed == coverVideoThumbnailUrl ? _self.coverVideoThumbnailUrl : coverVideoThumbnailUrl // ignore: cast_nullable_to_non_nullable
as String?,topMediaType: freezed == topMediaType ? _self.topMediaType : topMediaType // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Spot() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.latitude,_that.longitude,_that.difficulty,_that.bestSeason,_that.neighborhood,_that.openHour,_that.closeHour,_that.createdBy,_that.stateId,_that.cityId,_that.countryId,_that.cityName,_that.countryName,_that.categoryId,_that.categoryName,_that.ratingAvg,_that.ratingCount,_that.hazardAvg,_that.hazardCount,_that.voteCount,_that.coverPhotoUrl,_that.coverVideoUrl,_that.coverVideoThumbnailUrl,_that.topMediaType,_that.createdDate,_that.updatedDate,_that.sportIds);case _:
  return orElse();
...
class _Spot implements Spot {
  const _Spot({required this.id, required this.name, required this.description, required this.latitude, required this.longitude, this.difficulty, @JsonKey(name: 'best_season') this.bestSeason, this.neighborhood, @JsonKey(name: 'open_hour') this.openHour, @JsonKey(name: 'close_hour') this.closeHour, @JsonKey(name: 'created_by') required this.createdBy, @JsonKey(name: 'state_id') this.stateId, @JsonKey(name: 'city_id') this.cityId, @JsonKey(name: 'country_id') this.countryId, @JsonKey(name: 'city_name') this.cityName, @JsonKey(name: 'country_name') this.countryName, @JsonKey(name: 'category_id') required this.categoryId, @JsonKey(name: 'category_name') required this.categoryName, @JsonKey(name: 'rating_avg') this.ratingAvg, @JsonKey(name: 'rating_count') required this.ratingCount, @JsonKey(name: 'hazard_avg') this.hazardAvg, @JsonKey(name: 'hazard_count') required this.hazardCount, @JsonKey(name: 'vote_count') required this.voteCount, @JsonKey(name: 'cover_photo_url') this.coverPhotoUrl, @JsonKey(name: 'cover_video_url') this.coverVideoUrl, @JsonKey(name: 'cover_video_thumbnail_url') this.coverVideoThumbnailUrl, @JsonKey(name: 'top_media_type') this.topMediaType, @JsonKey(name: 'created_date') required this.createdDate, @JsonKey(name: 'updated_date') this.updatedDate, @JsonKey(name: 'sport_ids') final  List<int> sportIds = const []}): _sportIds = sportIds;
...
@override@JsonKey(name: 'cover_video_thumbnail_url') final  String? coverVideoThumbnailUrl;
@override@JsonKey(name: 'top_media_type') final  String? topMediaType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,latitude,longitude,difficulty,bestSeason,neighborhood,openHour,closeHour,createdBy,stateId,cityId,countryId,cityName,countryName,categoryId,categoryName,ratingAvg,ratingCount,hazardAvg,hazardCount,voteCount,coverPhotoUrl,coverVideoUrl,coverVideoThumbnailUrl,topMediaType,createdDate,updatedDate,const DeepCollectionEquality().hash(_sportIds)]);
