...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,latitude,longitude,difficulty,bestSeason,neighborhood,openHour,closeHour,createdBy,stateId,ratingAvg,ratingCount,hazardAvg,hazardCount,voteCount,coverPhotoUrl,coverVideoUrl,coverVideoThumbnailUrl,topMediaType,createdDate,updatedDate,const DeepCollectionEquality().hash(sportIds)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,latitude,longitude,difficulty,bestSeason,neighborhood,openHour,closeHour,createdBy,stateId,ratingAvg,ratingCount,hazardAvg,hazardCount,voteCount,coverPhotoUrl,coverVideoUrl,coverVideoThumbnailUrl,topMediaType,createdDate,updatedDate,const DeepCollectionEquality().hash(_sportIds)]);
