...
$RideStateCopyWith<RideState> get copyWith => _$RideStateCopyWithImpl<RideState>(this as RideState, _$identity);
  ...
  /// Serializes this RideState to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RideState&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'RideState(id: $id, name: $name, description: $description)';
}
...
class _RideState implements RideState {
  const _RideState({required this.id, required this.name, this.description});
  factory _RideState.fromJson(Map<String, dynamic> json) => _$RideStateFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$RideStateToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RideState&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description));
}
